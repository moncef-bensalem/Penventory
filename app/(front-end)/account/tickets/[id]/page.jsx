      ...
      <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <div 
                      className={`max-w-3/4 rounded-lg p-4 ${
                        message.sender.role === 'MANAGER' 
                          ...
                          : 'bg-orange-50 border border-orange-100 dark:bg-orange-900/40 dark:border-orange-800'
                      }`}
                    >
                  ...
                  <div className="border-t pt-6 mt-8">
                    ...
                    <div className="mb-4">
                      <textarea
                        ...
                        rows={4}
                        className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 bg-white text-gray-900 dark:bg-gray-800 dark:text-white dark:border-gray-700"
                      ></textarea>
                    </div>
                    <div className="flex justify-between items-center">
                      <button 
                        className="text-gray-600 border border-gray-300 px-4 py-2 rounded-md flex items-center hover:bg-gray-50 transition-colors dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800"
                      >
                      ...
                      <button 
                        ...
                        className={`bg-orange-600 text-white px-6 py-2 rounded-md flex items-center hover:bg-orange-700 transition-colors dark:bg-orange-700 dark:hover:bg-orange-800 ${
        ...
        <div className="bg-gray-100 rounded-lg p-6 dark:bg-gray-800">
          ...
          <div className="flex space-x-4">
            <Link 
              href="/contact" 
              className="bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-700 transition-colors dark:bg-orange-700 dark:hover:bg-orange-800"
            >
              Nouveau ticket
            </Link>
            <Link 
              href="/help" 
              className="bg-white text-orange-600 border border-orange-600 px-4 py-2 rounded-md hover:bg-orange-50 transition-colors dark:bg-gray-900 dark:text-orange-400 dark:border-orange-700 dark:hover:bg-gray-800"
            >
              Centre d'aide
            </Link>
          </div>
